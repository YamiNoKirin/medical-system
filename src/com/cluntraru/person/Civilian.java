...
public class Civilian extends Person {
    public Civilian(AdminEntity adminEntity, boolean isAlive, boolean isSick, String name) {
        super(adminEntity, isAlive, isSick, name);
    }

    public Civilian(AdminEntity adminEntity, boolean isAlive, boolean isSick, String name, Hospital hospital) {
